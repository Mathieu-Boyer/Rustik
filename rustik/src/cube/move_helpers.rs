...
impl Cube {
    ...
    pub fn undo(&mut self, move_face: &usize, move_is_clockwise: &bool, num : &i8) {
        self.apply_move( move_face, &(!(*move_is_clockwise)), num)
    }
    
    pub fn apply_move(&mut self, move_face: &usize, move_is_clockwise: &bool, num : &i8){
